...
function Servicemanage() {
  ...
  return (
    <div>
      <Aheader />
      <Anavbar title="Service manage" name="service manage" />
          ...
          <div class="modal-content">
            <div className="blog-item">
              <div className="blog-img">
                <img src={servicedata.img} className="img-fluid rounded-top w-100" style={{ height: "450px" }} alt="Image" />
              </div>
              <div className="blog-content rounded-bottom p-4">
                {/* <a href="#" className="h4 d-block mb-3">Rental Cars how to check driving fines?</a> */}
                <h5 className='mb-3'>{servicedata.title}</h5>
                <p className="mb-3" style={{}}>{servicedata.desc}</p>
            ...
            <div className="wow fadeInUp" data-wow-delay="0.2s">
              ...
              <form className='p-3' >
                <div className="row g-3">
                  ...
                  <div className="col-6">
                    <button className="btn btn-danger w-100 py-3 mb-3" type="cancel" onClick={() => setupdateservice(null)}>Cancel</button>
                  </div>
                </div>
              </form>
            </div>
